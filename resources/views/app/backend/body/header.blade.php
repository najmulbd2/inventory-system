    ...
    <div class="container-fluid">
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                <!-- Language -->
                <div id="time" class="text-success fw-semibold"></div>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="{{ (!empty($user->image))? url('upload/backend/user_images/'.$user->image) : url('upload/no_image.jpg') }}" alt class="rounded-circle" />
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="{{ route('edit.profile') }}">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <span class="fw-semibold d-block lh-1">{{ ((Auth::user()->id) && ($user->name != null))? $user->name  :'Unknown' }}</span>
                                        <small>
                                            {{ ((Auth::user()->id) && ($user->usertype != null) && ( $user->usertype == 1))? "Admin" :((Auth::user()->id) && ($user->usertype != null) && ( $user->usertype == 2)? "Manager" : "Unknown") }}
                                        </small>
                                    </div>
                                </div>
                            </a>
